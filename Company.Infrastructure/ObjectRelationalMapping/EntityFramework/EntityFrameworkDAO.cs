...
using WireOps.Company.Infrastructure.Persistence.Crud;
using WireOps.Company.Infrastructure.Persistence.Crud.Operations;
...
public class EntityFrameworkDAO
{
    ...
    protected EntityFrameworkDAO(DbContext context) => _context = context;
